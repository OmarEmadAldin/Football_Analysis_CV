...
from utils import get_center_of_bbox, get_foot_position, get_bbox_width
class Tracker:
    ...
    def collect_pitch_positions(self, tracks):
        for frame_data in tracks['players']:
            for player_id, player_info in frame_data.items():
                ...
                self.player_positions[player_id].append(pos)
